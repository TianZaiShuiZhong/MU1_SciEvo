...
| language        | string   | 否           | ch                                                  | 指定文档语言，默认 `ch`。可选值见 [language 取值参考](https://mineru.net/apiManage/docs#language-取值参考)。仅对 pipeline、vlm 模型有效 |
...
| language       | string | 可选         | 解析语言，影响 OCR 识别效果。默认 `ch`。可选值见 [language 取值参考](https://mineru.net/apiManage/docs#language-取值参考)。仅对 PDF 文件生效 |
